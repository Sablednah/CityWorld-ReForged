...
//				break;
		...
		if (generator.getSettings().includeShops && generator.worldEnvironment != Environment.NETHER
			...
			placeFarmWorkstation(generator, chunk, cropY);
	...
	private void placeFarmWorkstation(CityWorldGenerator generator, RealBlocks chunk, int cropY) {
		...
		for (int i = 0; i < candidates.length; i++) {
			...
			generator.spawnProvider.spawnWorker(generator, chunk, chunkOdds, x, cropY, z,
					new net.minecraft.resources.ResourceLocation("farmer"));
			return;
		}
	}
...
//							chunk.setBlock(x, croplevel + 5, z, Material.DIAMOND_BLOCK);
	...
	private static net.minecraft.tags.TagKey<net.minecraft.world.level.levelgen.feature.ConfiguredFeature<?, ?>> orchardTag(
		...
		return net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.CONFIGURED_FEATURE,
				new net.minecraft.resources.ResourceLocation("cityworld", "orchard/" + climate));
	}
