...
//			
	...
	private void generateSkyWalkBitsN(RealBlocks chunk, int x, int z, int skywalkAt) {
		...
		chunk.setBlocks(x + 1, x + 2, skywalkAt - 1, z, z + 4, Material.IRON_BARS, BlockFace.NORTH, BlockFace.SOUTH,
				BlockFace.EAST);
		chunk.setBlocks(x + 2, x + 3, skywalkAt - 1, z, z + 4, Material.IRON_BARS, BlockFace.NORTH, BlockFace.SOUTH,
				BlockFace.WEST);
	}
	...
	private void generateSkyWalkBitsS(RealBlocks chunk, int x, int z, int skywalkAt) {
		...
		chunk.setBlocks(x + 3, x + 4, skywalkAt + 1, z + 1, z + 4, Material.IRON_BARS, BlockFace.NORTH,
				BlockFace.SOUTH);
		chunk.setBlocks(x + 1, x + 2, skywalkAt - 1, z, z + 4, Material.IRON_BARS, BlockFace.NORTH, BlockFace.SOUTH,
				BlockFace.EAST);
		chunk.setBlocks(x + 2, x + 3, skywalkAt - 1, z, z + 4, Material.IRON_BARS, BlockFace.NORTH, BlockFace.SOUTH,
	...
	private void generateSkyWalkBitsW(RealBlocks chunk, int x, int z, int skywalkAt) {
		...
		chunk.setBlocks(x, x + 4, skywalkAt - 1, z + 1, z + 2, Material.IRON_BARS, BlockFace.EAST, BlockFace.WEST,
				BlockFace.SOUTH);
		chunk.setBlocks(x, x + 4, skywalkAt - 1, z + 2, z + 3, Material.IRON_BARS, BlockFace.EAST, BlockFace.WEST,
				BlockFace.NORTH);
	}
	...
	private void generateSkyWalkCross(CityWorldGenerator generator, RealBlocks chunk, Surroundings neighbors,
		...
		chunk.setBlocks(7, 9, skywalkAt - 1, 7, 9, Material.IRON_BARS, BlockFace.NORTH, BlockFace.SOUTH, BlockFace.EAST,
				BlockFace.WEST);
		if (doNorthward) {
