...
//		chunk.setLayer(sidewalkLevel, sidewalkMaterial);
	...
	protected void generateActualBlocks(CityWorldGenerator generator, PlatMap platmap, RealBlocks chunk,
		...
		Material underneath = generator.materialProvider.itemsSelectMaterial_BuildingCeilings
				.getRandomMaterial(chunkOdds);
...
//		chunk.setSignPost(8, sidewalkLevel + 21, 8, BlockFace.NORTH, "Style", centerStyle.toString());
		...
		case ART_ZONE:
			...
			break;
		case UPWARD_POND:
			chunk.setBlocks(3, 13, sidewalkLevel, 3, 13, Material.STONE_SLAB, SlabType.DOUBLE);
			chunk.setBlocks(4, 12, sidewalkLevel + 1, 4, 12, Material.STONE_SLAB);
			chunk.setBlocks(5, 11, sidewalkLevel + 1, 5, 11, Material.STONE_SLAB, SlabType.DOUBLE);
			...
			break;
		case DOWNWARD_POND:
			chunk.setBlocks(3, 13, sidewalkLevel - 1, 3, 13, Material.STONE_SLAB, SlabType.DOUBLE);
			chunk.setBlocks(4, 12, sidewalkLevel - 1, 4, 12, Material.STONE_SLAB);
			chunk.setBlocks(5, 11, sidewalkLevel - 2, 5, 11, Material.STONE_SLAB, SlabType.DOUBLE);
			chunk.setBlocks(6, 10, sidewalkLevel - 2, 6, 10, Material.STONE_SLAB);
	...
	private void generateSittingArea(RealBlocks chunk, int y, Material atmosphere, Material underneath) {
		...
		if (chunkOdds.flipCoin()) {
			...
			chunk.setStair(3, y, 3, Material.QUARTZ_STAIRS, BlockFace.NORTH, StairsShape.INNER_LEFT);
			chunk.setStair(12, y, 3, Material.QUARTZ_STAIRS, BlockFace.NORTH, StairsShape.INNER_RIGHT);
			chunk.setStair(3, y, 12, Material.QUARTZ_STAIRS, BlockFace.SOUTH, StairsShape.INNER_RIGHT);
			chunk.setStair(12, y, 12, Material.QUARTZ_STAIRS, BlockFace.SOUTH, StairsShape.INNER_LEFT);
			for (int i = 4; i < 7; i++) {
				chunk.setBlock(i, y, 3, Material.QUARTZ_STAIRS, BlockFace.NORTH);
