...
//			Material emptyMaterial = getAirMaterial(generator, sewerY - 1);
			...
			if (centerNorth) {
				...
				chunk.setBlock(7, sewerY, 4, Material.COBBLESTONE, SlabType.TOP);
				chunk.setBlock(8, sewerY, 4, Material.COBBLESTONE, SlabType.TOP);
			...
			if (centerSouth) {
				...
				chunk.setBlock(7, sewerY, 11, Material.COBBLESTONE, SlabType.TOP);
				chunk.setBlock(8, sewerY, 11, Material.COBBLESTONE, SlabType.TOP);
			...
			if (centerWest) {
				...
				chunk.setBlock(4, sewerY, 7, Material.COBBLESTONE, SlabType.TOP);
				chunk.setBlock(4, sewerY, 8, Material.COBBLESTONE, SlabType.TOP);
			...
			if (centerEast) {
				...
				chunk.setBlock(11, sewerY, 7, Material.COBBLESTONE, SlabType.TOP);
				chunk.setBlock(11, sewerY, 8, Material.COBBLESTONE, SlabType.TOP);
