...
import me.daddychurchill.CityWorld.compat.TreeType;
...
public abstract class TreeProvider {
	...
	public static WoodSpecies getTreeSpecies(TreeType treeType) {
		switch (treeType) {
		case ACACIA:
			return WoodSpecies.ACACIA;
		case DARK_OAK:
			return WoodSpecies.DARK_OAK;
		case JUNGLE:
		case JUNGLE_BUSH:
		case SMALL_JUNGLE:
		case COCOA_TREE:
			return WoodSpecies.JUNGLE;
		case TALL_REDWOOD:
		case MEGA_REDWOOD:
		case REDWOOD:
			return WoodSpecies.REDWOOD;
		case BIRCH:
		case TALL_BIRCH:
			return WoodSpecies.BIRCH;
		case SWAMP:
		case BIG_TREE:
		case TREE:
		case BROWN_MUSHROOM:
		case RED_MUSHROOM:
		default:
			return WoodSpecies.GENERIC;
		}
	}

	public static TreeType getTreeType(WoodSpecies treeSpecies) {
		switch (treeSpecies) {
		case ACACIA:
