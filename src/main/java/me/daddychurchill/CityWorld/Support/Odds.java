...
public final class Odds {
	...
	public Vec3 getRandomVelocity() {
		return getRandomVelocity(1.0);
	}

	private Vec3 getRandomVelocity(double delta) {
		return new Vec3((random.nextDouble() * delta * 2) - delta, 0, (random.nextDouble() * delta * 2) - delta);
	}
	...
	public WoodSpecies getRandomWoodSpecies() {
