...
import me.daddychurchill.CityWorld.compat.WoodSpecies;
...
public final class Trees {
	...
	public WoodSpecies getRandomSpecies() {
		WoodSpecies[] values = WoodSpecies.values();
	...
	public static Material getRandomWoodSign(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	public static Material getRandomWoodWallSign(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	public static Material getRandomWoodLog(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	private static Material getRandomWoodStairs(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	private static Material getRandomWoodSlab(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	private static Material getRandomWoodDoor(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	private static Material getRandomWoodTrapDoor(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	private static Material getRandomWoodFence(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
	...
	public static Material getRandomWoodLeaves(WoodSpecies species) {
		switch (species) {
		default:
		case ACACIA:
