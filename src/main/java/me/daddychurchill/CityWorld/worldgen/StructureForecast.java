...
public final class StructureForecast {
    ...
    private StructureStart tryGenerate(StructureSet.StructureSelectionEntry entry, Bound b, ChunkPos pos) {
        ...
        StructureStart start = structure.generate(b.registries(), generator, generator.getBiomeSource(),
                state.randomState(), b.templates(), state.getLevelSeed(), pos, 0, b.height(), validBiome);
