...
where Macaw's puts its gates too); garage doors (a different block shape); Macaw's *Stairs* (its
loft, compact and terrace stairs, balconies and railings are single blocks with their own geometry,
not a stair-shaped drop-in for the stairwells CityWorld draws — a future arc); tiki torches and garden
lights (no placer yet — campgrounds, beaches and park paths would want them).
