...
| `cityworld:fittings/site_fence` | the tall fence round a construction site or a factory's metal yard — one per platmap; iron bars two picks in five, this pool seven in twenty, barbed wire one in four | iron bars + Macaw's industrial metal fences (mesh, panelled, bastion…) |
