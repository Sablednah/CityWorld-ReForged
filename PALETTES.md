...
| `cityworld:fittings/fence` | house railings, farm paddocks, park edges, barn pens, factory yards | the vanilla wooden fences by id + Macaw's picket, horse, stockade and wired fences and its hedges |
...
sweep, which is why the fence pool lists the vanilla fences by id rather than `#minecraft:wooden_fences`,
